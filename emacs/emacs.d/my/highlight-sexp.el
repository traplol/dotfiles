...
;; default=#ff5555
(defcustom hl-sexp-underline-color
  nil
  "*The color used for the background of the highlighted sexp."
  :type 'color
  :group 'highlight-sexp)
...
(defun hl-sexp--enable ()
  ...
  (set 'highlight-sexp-mode t))
(defun hl-sexp--disable ()
...
(defun reload-this-mode ()
  (unload-feature 'highlight-sexp)
  (load-file "./highlight-sexp.el")
  (highlight-sexp-mode))
;(reload-this-mode)
